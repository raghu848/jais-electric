    ...
    <footer className="bg-white border-t border-[#F07F22]/20">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm sm:text-base text-gray-600">
                <Phone className="w-4 h-4 text-[#F07F22] sm:w-5 sm:h-5" />
                <a 
              ...
              <div className="flex items-center gap-2 text-sm sm:text-base text-gray-600">
                <Mail className="w-4 h-4 text-[#F07F22] sm:w-5 sm:h-5" />
                <a 
              ...
              <div className="flex items-start gap-2 text-sm sm:text-base text-gray-600">
                <MapPin className="w-4 h-4 text-[#F07F22] sm:w-5 sm:h-5 mt-0.5" />
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-base sm:text-lg font-bold text-[#0A192F] mb-3 sm:mb-4 font-[family-name:var(--font-poppins)]">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-base sm:text-lg font-bold text-[#0A192F] mb-3 sm:mb-4 font-[family-name:var(--font-poppins)]">Services</h3>
            <ul className="space-y-2">
              <li>
