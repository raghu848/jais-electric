  ...
  return (
    <Section3D className="py-10 sm:py-12 relative overflow-hidden">
      ...
      <div ref={ref} className="mx-auto max-w-6xl px-4 relative z-10">
        <div className="rounded-2xl bg-white/90 backdrop-blur-sm ring-1 ring-gray-200 shadow-xl">
          <div className="grid gap-0 divide-y divide-gray-200 sm:grid-cols-2 sm:divide-y-0 sm:divide-x lg:grid-cols-4">
            {stats.map((s) => (
              <StatItem
                key={s.label}
                label={s.label}
...
function StatItem({
  ...
  return (
    <div className="px-6 py-8 text-center">
      ...
      <div className="mt-2 text-xs font-bold uppercase tracking-widest text-gray-600 font-heading font-normal">
        {label}
      </div>
    </div>
  );
