  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#0A192F] to-[#0C4A6E]">
      <div className="mx-auto max-w-6xl px-6">
            ...
            >
              <div className="flex flex-col h-full">
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-light text-white mb-3 font-[family-name:var(--font-montserrat)]">
                    {solution.title}
                  </h3>
        ...
        >
          <h3 className="text-3xl font-light text-white mb-4 font-[family-name:var(--font-montserrat)]">
