      ...
      <Section3D className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8">
          ...
          >
            ...
            <h1 className="mb-7 bg-gradient-to-r from-white via-slate-200 to-[#F07F22] bg-clip-text font-[family-name:var(--font-montserrat)] text-6xl font-bold tracking-tight text-transparent lg:text-6xl">
              EXCELLENCE
            </h1>
